...
@class HLLAnimatedImage;
@protocol HLLAnimatedImageViewDebugDelegate;


//
//  An `HLLAnimatedImageView` can take an `HLLAnimatedImage` and plays it automatically when in view hierarchy and stops when removed.
...
//
@interface HLLAnimatedImageView : UIImageView
...
@property (nonatomic, strong) HLLAnimatedImage *animatedImage;
