...
@implementation HLLImageCropManager
...
+ (UIImage *)cropImageView:(UIImageView *)imageView toRect:(CGRect)rect zoomScale:(double)zoomScale containerView:(UIView *)containerView{
    ...
    CGFloat xMargin = containerView.al_width - CGRectGetMaxX(rect) - rect.origin.x;
    ...
    cropedImage = [[HLLImageManager manager] fixOrientation:cropedImage];
