...
- (void)setPoints {
    ...
    a = CGPointMake(0, self.bounds.size.height-kCropButtonSize);
    b = CGPointMake(self.bounds.size.width-kCropButtonSize, self.bounds.size.height-kCropButtonSize);
    c = CGPointMake(self.bounds.size.width-kCropButtonSize, 0);
    d = CGPointMake(0, 0);
...
- (void)setButtons {
    ...
    [_pointD setFrame:CGRectMake(d.x , d.y , kCropButtonSize, kCropButtonSize)];
    [_pointC setFrame:CGRectMake(c.x , c.y , kCropButtonSize, kCropButtonSize)];
    [_pointB setFrame:CGRectMake(b.x , b.y , kCropButtonSize, kCropButtonSize)];
    [_pointA setFrame:CGRectMake(a.x , a.y , kCropButtonSize, kCropButtonSize)];
    
    [_pointE setFrame:CGRectMake(e.x , e.y , kCropButtonSize, kCropButtonSize)];
    [_pointF setFrame:CGRectMake(f.x , f.y , kCropButtonSize, kCropButtonSize)];
    [_pointG setFrame:CGRectMake(g.x , g.y , kCropButtonSize, kCropButtonSize)];
    [_pointH setFrame:CGRectMake(h.x , h.y , kCropButtonSize, kCropButtonSize)];
}
...
- (void)moveActivePointToLocation:(CGPoint)locationPoint {
    ...
    if(newX<self.bounds.origin.x+kCropButtonSize/2){
        newX=self.bounds.origin.x+kCropButtonSize/2;
    }else if(newX+kCropButtonSize/2>self.al_width){
        newX = self.al_width-kCropButtonSize/2;
    }
    if(newY<self.bounds.origin.y+kCropButtonSize/2){
        newY=self.bounds.origin.y+kCropButtonSize/2;
    }else if(newY+kCropButtonSize/2>self.al_height){
        newY = self.al_height-kCropButtonSize/2;
    }
